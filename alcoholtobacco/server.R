      ...
      for (i in input$LAinput){
        ...
        if(input$comparison=="SCO"){
          ...
          popup <- paste0("<h3>", Datazone$name, "</h3><br>",
                          "<b> Geography </b> </br>",
                          "This datazone is within the Intermediate Zone: ", Datazone@data$Intermediate_Zone, " and the Local Authority of ", Datazone@data$Councilname, "<br/>",
                          "<b> Alcohol and Tobacco Outlet Density </b></br>",
                          "<ul><li>Density around the population centre is ", "<strong>", round(Datazone@data[,16], 2)," per km2","</strong></li>",
                          "<br/>",
                          "<li>This is <strong>", round((Datazone@data[,16]/Datazone$Scottishaverage*100),0), ifelse(round(Datazone@data[,16], 2)>round(Datazone$Scottishaverage, 2) ,"% higher</strong> than", "%</strong> of")," the Scottish average</li>",
                          "<br/></ul>",
                          ifelse(Datazone@data[,16]>Scottish90th, "<strong>This datazone is in the top 10% of neighbourhoods in Scotland</strong>", ""),"</br>",
                          "<b> Health </b></br>",
