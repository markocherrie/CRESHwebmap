      ...
      for (i in input$LAinput){
        ...
        if(input$comparison=="SCO"){
          ...
          popup <- paste0("<h3>", Datazone$name, "</h3><br>",
                          "<b> Geography </b> </br>",
                          "This datazone is within the intermediate zone of ", Datazone@data$Intermediate_Zone, " and the local authority of ", Datazone@data$Councilname,
                          "</br><b> Alcohol and Tobacco Outlet Density </b></br>",
                          "<ul><li>Density around the population centre is ", "<font color='#EE2C2C'>", round(Datazone@data[,16], 2)," per km2","</font></li>",
                          "<br/>",
                          "<li>This is <font color='#EE2C2C'>", round((Datazone@data[,16]/Datazone$Scottishaverage*100),0), ifelse(round(Datazone@data[,16], 2)>round(Datazone$Scottishaverage, 2) ,"% higher</font> than", "%</font> of")," the Scottish average</li>",
                          "<br/><li>",
                          ifelse(Datazone@data[,16]>Scottish90th, "This datazone is ", "<font color='#EE2C2C'>in</font>"," the top 10% of neighbourhoods in Scotland</li></ul>", "This datazone is ", "<font color='#EE2C2C'>not</font>", " within the top 10% of neighbourhoods in Scotland</li></ul>"),"</br>",
                          "<b> Health </b></br>",
                          "<ul><li>Hospital stays related to alcohol misuse: standardised ratio: <font color='#EE2C2C'>", Datazone@data$ALCOHOL, "</font></li></br>",
                          "<li>Proportion of population being prescribed drugs for anxiety, depression or psychosis: <font color='#EE2C2C'>", Datazone@data$DEPRESS,"</font></li></br>",
                          "<li>Standardised mortality ratio: <font color='#EE2C2C'>", Datazone@data$SMR,"</font></li>",
                          "<br/>",
                          "<br/>",
