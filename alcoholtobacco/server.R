      ...
      for (i in input$LAinput){
        ...
        if(input$comparison=="SCO"){
          ...
          popup <- paste0("<h3>", Datazone$name, "</h3><br>",
                          ...
                          "<br/>",
                          ifelse(Datazone@data[,16]>Scottish90th, "<strong><font color='#EE2C2C'>This datazone is in the top 10% of neighbourhoods in Scotland</font></strong>", ""),"</br>",
                          "<b> Health </b></br>",
                          "Hospital stays related to alcohol misuse: standardised ratio: ", Datazone@data$ALCOHOL, "</br>",
                          "Proportion of population being prescribed drugs for anxiety, depression or psychosis: ", Datazone@data$DEPRESS,"</br>",
